...
const API_BASE_URL = 'https://your-production-api.com/api/v1'; //server
...
export const practicalSeriesAPI = {
  ...
  uploadPDF: (subjectId, seriesId, file) => {
    ...
    formData.append('file', file);
    return apiCall(
      `/subjects/${subjectId}/practical-series/${seriesId}/pdfs`,
  ...
  deletePDF: (subjectId, seriesId, pdfId) =>
    apiCall(
      `/subjects/${subjectId}/practical-series/${seriesId}/pdfs/${pdfId}`,
      { method: 'DELETE' }
    ),
...
export const theoreticalSeriesAPI = {
  ...
  uploadPDF: (subjectId, seriesId, file) => {
    ...
    formData.append('file', file);
    return apiCall(
      `/subjects/${subjectId}/theoretical-series/${seriesId}/pdfs`,
      { method: 'POST', body: formData }
    );
  },
  ...
  deletePDF: (subjectId, seriesId, pdfId) =>
    apiCall(
      `/subjects/${subjectId}/theoretical-series/${seriesId}/pdfs/${pdfId}`,
      { method: 'DELETE' }
    ),
...
export const examsAPI = {
  ...
  parsePDF: (subjectId, examId, pdfId, aiSubject) =>
    apiCall(
      `/subjects/${subjectId}/exams/${examId}/pdfs/${pdfId}/parse?ai_subject=${encodeURIComponent(aiSubject)}`,
      { method: 'POST' }
    ),

  getParseStatus: (subjectId, examId, pdfId) =>
    apiCall(
      `/subjects/${subjectId}/exams/${examId}/pdfs/${pdfId}/parse-status`
    ),
};
