...
class Question(BaseModel):
    ...
    question_text: str
    intro_context: Optional[str] = Field(None, serialization_alias="introduction_context")
    choices: list[str] = Field(default_factory=list)
    solution: Optional[Solution] = Field(None, serialization_alias="Solution")
...
class Exercise(BaseModel):
    ...
    id: str
    title: str
    total_points: Optional[float] = Field(None, serialization_alias="total_exercise_points")
    intro_context: Optional[str] = Field(None, serialization_alias="introduction_context")
    questions: list[Question] = Field(default_factory=list, serialization_alias="Question")
